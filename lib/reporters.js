...
// DataDogReporter
//
function DataDogReporter(apiKey, appKey, agent, api_host) {
    apiKey = apiKey || process.env.DATADOG_API_KEY;
    appKey = appKey || process.env.DATADOG_APP_KEY;
    api_host = api_host || process.env.DATADOG_API_HOST || "api.datadoghq.com";
    ...
    dogapi.initialize({ api_key: apiKey, app_key: appKey, api_host: api_host, proxy_agent: agent });
