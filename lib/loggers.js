...
function BufferedMetricsLogger(opts) {
    this.aggregator = opts.aggregator || new Aggregator(opts);
...
BufferedMetricsLogger.prototype.addPoint = function(Type, key, value, tags, options) {
    this.aggregator.addPoint(Type, this.prefix + key, value, tags, this.host, options);
};
...
BufferedMetricsLogger.prototype.histogram = function(key, value, tags, options) {
    this.addPoint(Histogram, key, value, tags, options);
};
